...
public class UserGameUpdateRequest {
    ...
    /*
     * userId and userGameID does not need to be included when receiving the packaged JSON for the DTO, as userId is
     * extracted from the endpoint PUT /api/users/{id}/games/{userGameId}
     */
}
